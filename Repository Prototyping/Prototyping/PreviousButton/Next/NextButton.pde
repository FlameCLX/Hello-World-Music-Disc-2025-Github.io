...
float playX1 = imageX + imageWidth * 6/8; //TopLeft Width
float playY1 = imageY + imageHeight * 6/8; //Topleft Height
float playX2 = imageX + imageWidth * 3/8; //Right Width
float playY2 = imageY + imageHeight *1/2; //Right Height
float playX3 = imageX + imageWidth * 6/8; //BottomLeft Width
float playY3 = imageY + imageHeight * 2/8; //BottomLeft Height
float imageR = appWidth * 3/8;
